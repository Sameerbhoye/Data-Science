# -*- coding: utf-8 -*-
"""
Created on Fri Jun  7 21:19:56 2024
...
gen=range_even(6)   #instead of using for loop we can use our own generator 
next(gen)
next(gen)
next(gen)
...
import string
adjectives=input("Enter the adjectives :")
...
#wont display last data in lst2
#solution
...
#count function
import itertools as it
counter=it.count(start=1) #start=1 and 0 by default
print(next(counter))
print(next(counter))
...
import itertools as it
players=["john","johny","janardhan","jaikal"]
